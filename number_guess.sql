...
INSERT INTO public.games VALUES (1, 1, 4, 509);
...
INSERT INTO public.players VALUES (1, 'Laleh');
...
--
-- Name: games games_player_id_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_player_id_fkey1 FOREIGN KEY (player_id) REFERENCES public.players(player_id);
